package com.team3238.electro.opencv;
...
public class CameraGLSurfaceView extends GLSurfaceView {
    ...
    public interface CameraTextureListener {
         ...
         */
        public boolean onCameraTexture(int texIn, int texOut, int width,
    ...
    public CameraGLSurfaceView(Context context, AttributeSet attrs, Camera2Renderer.Settings settings) {
        super(context, attrs);
        ...
        mRenderer = new Camera2Renderer(this, settings);
